...
const AddNurseModal = ({ isOpen, onClose, onNurseAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Create nurse object
      const newNurse = {
        id: `NUR${String(Math.floor(Math.random() * 1000)).padStart(3, '0')}`,
      ...
      console.log('New nurse created:', newNurse);
      
      // Call the callback function to notify parent component
      if (onNurseAdded) {
        onNurseAdded(newNurse);
      }
          ...
          <div className="bg-gradient-to-r from-green-50 to-gray-50 border-b border-gray-200 px-6 py-6 flex-shrink-0">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900">Add New Nurse</h3>
                  <p className="text-sm text-gray-600 mt-1">Create a comprehensive nurse profile</p>
                </div>
              </div>
              <button
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/60 p-6">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Nursing credentials and expertise</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    >
                      ...
                      <option value="Urology Clinical Nurse">Urology Clinical Nurse</option>
                      <option value="Senior Urology Nurse">Senior Urology Nurse</option>
