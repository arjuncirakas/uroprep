...
const SuperadminSidebar = ({ isOpen, onClose, isCollapsed, onToggleCollapse }) => {
  ...
  const navigationItems = [
    { path: '/superadmin/doctors', label: 'Doctors', icon: Stethoscope },
    { path: '/superadmin/nurses', label: 'Nurses', icon: UserCog },
  ];
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 text-left">
                <h4 className="font-semibold text-sm text-gray-800">{user?.name || 'Super Admin'}</h4>
