...
const AddPatient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Generate patient ID
      const newId = `URP${String(Math.floor(Math.random() * 10000)).padStart(4, '0')}`;
      ...
      const newPatient = {
        ...
        psa: parseFloat(formData.initialPSA),
        status: formData.pathway,
        database: formData.pathway === 'OPD Queue' ? 'DB1' : 
                 formData.pathway === 'Active Surveillance' ? 'DB2' :
                 formData.pathway === 'Surgical Pathway' ? 'DB3' : 'DB4',
        referralDate: formData.referralDate,
        referringGP: formData.referringGP,
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Enter patient information to add them to the urology system</p>
            </div>
          </div>
        </div>
      </div>
