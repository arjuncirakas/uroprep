...
import MDTCoordinatorSidebar from '../components/layout/MDTCoordinatorSidebar';
import Header from '../components/layout/Header';

const MDTCoordinatorLayout = () => {
...
export default MDTCoordinatorLayout;
